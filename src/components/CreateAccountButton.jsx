...
export const CreateAccount = ({ className = "", size = "md", children }) => {
  ...
  const baseClasses = "bg-primary focus-visible:ring- focus:outline-none focus-visible:ring-2 rounded-full relative overflow-hidden font-medium hover:bg-primary/80 shadow-lg shadow-primary/40 cursor-pointer transition-all duration-200"
